	...
	public Tokenizer getTokenizer(INDEXFIELD field) throws TokenizerException {
		...
		try {
			...
			if (field.toString().equalsIgnoreCase("TERM")) {
				return new Tokenizer(new StopWordsRule(), new WhitespaceRule(),
						new AccentRule(), new SpecialCharRule(), /* Date? */
						new NumberRule(), new PunctuationRule(),
						new ApostropheRule(),/* new HyphenRule(), */
